...
namespace Autodesk.APS.RevitIO.CreateWindow
{
    ...
    /// </summary>
    class FixedWinCreation : WindowCreation
    {
        ...
        {
            //create common 
            m_dimensionCreator = new CreateDimension(m_application, m_document);
            m_extrusionCreator = new CreateExtrusion(m_application, m_document);
